...
resource "aws_cognito_resource_server" "shows_api" {
  ...
  identifier   = "https://${local.resource_prefix}.api"
...
resource "aws_cognito_user_pool_client" "app_client" {
  ...
  allowed_oauth_scopes                  = [
    "${aws_cognito_resource_server.shows_api.identifier}/shows.read",
    "${aws_cognito_resource_server.shows_api.identifier}/shows.write"
  ]
